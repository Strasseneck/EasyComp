...
def endmatch(id):
    ...
    id1 = info[0]["competitor1_id"]
    id2 = info[0]["competitor2_id"]
   ...
   # update table
    ...
    db.execute("INSERT INTO matchresults (id, comp_id, div_id, div_name, competitor1_name, competitor2_name, competitor1_id, competitor2_id, winner, method) VALUES (?,?,?,?,?,?,?,?,?,?)",
                            id, comp_id, div_id, divname, competitor1, competitor2, id1, id2, name, method) 
